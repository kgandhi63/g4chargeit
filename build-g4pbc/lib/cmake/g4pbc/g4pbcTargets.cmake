...
foreach(_cmake_expected_target IN ITEMS g4pbc::g4pbc)
...
# Create imported target g4pbc::g4pbc
add_library(g4pbc::g4pbc SHARED IMPORTED)

set_target_properties(g4pbc::g4pbc PROPERTIES
  COMPATIBLE_INTERFACE_STRING "g4pbc_MAJOR_VERSION"
  ...
  INTERFACE_g4pbc_MAJOR_VERSION "1"
)

# Load information for each installed configuration.
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/g4pbcTargets-*.cmake")
