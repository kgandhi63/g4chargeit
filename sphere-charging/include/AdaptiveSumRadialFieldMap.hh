...
public:
    ...
    // UPDATED: Constructor now takes charge positions and charges directly
...
private:
    ...
    // Field data - now populated directly from constructor
    ...
    std::unique_ptr<Node> createOctreeFromScratch(const G4ThreeVector& min,
                                                  const G4ThreeVector& max,
                                                  int depth);

    // Gradient-based refinement with depth tracking
