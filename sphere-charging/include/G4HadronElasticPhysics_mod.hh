...
#ifndef G4HadronElasticPhysics_mod_h
#define G4HadronElasticPhysics_mod_h 1
...
class G4HadronElasticPhysics_mod : public G4VPhysicsConstructor
{
public: 

  explicit G4HadronElasticPhysics_mod(G4int ver = 0, 
				  const G4String& nam = "hElasticWEL_CHIPS_XS"); 

  virtual ~G4HadronElasticPhysics_mod();
...
private:
  ...
  G4HadronElasticPhysics_mod(G4HadronElasticPhysics_mod &) = delete;
  G4HadronElasticPhysics_mod & operator=(const G4HadronElasticPhysics_mod &right) = delete;
