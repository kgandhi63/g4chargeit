...
eventnumbers_allparticles = 50000 # adjusted this number to reflect the timestep in Zimmerman manuscript
iterationNUM = 200 # number of iterations to perform
temperature = 425 # temperature for dissipation model, units: kelvin
density = 1.9 # density of SiO2, units: g/cm3
...
CAD_dimensions = (120, 105, 137) # in units of microns 110 100 162
...
def write_macro(f, increment_filename, event_num, iterationTime, input_files=None, minStep=1):
    ...
    f.write('/sphere/cadinput/file irregular_spheres_frompython.stl\n')
